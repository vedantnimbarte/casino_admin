...
import { IconButton, Tooltip, Box, Button, FormControl, InputLabel, TextField } from '@mui/material';
// import DataTable from 'mui-datatables';
import { IconCirclePlus as AddIcon, IconX as CloseIcon } from '@tabler/icons';
...
function FAQ() {
    ...
    return (
        <Box>
            ...
            >
                <Box>
                    <DataTable title="FAQ's List" data={data} columns={columns} options={options} />
                </Box>
            </MainCard>
