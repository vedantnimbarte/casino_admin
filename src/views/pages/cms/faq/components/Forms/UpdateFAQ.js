...
import { updateFAQ } from 'store/thunk/cms/faq.thunk';

function CreateFAQ({ faq, dispatch, isMobileDevice, openModal, setOpenModal, theme, faqIndex }) {
    const formik = useFormik({
        initialValues: {
            question: faq.data[faqIndex].QUESTION || '',
            answer: faq.data[faqIndex].ANSWER || '',
            id: faq.data[faqIndex].FAQ_ID
        },
