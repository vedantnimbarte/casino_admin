...
import gamesSchema from 'schema/game.schema';

function UpdateGames({ dispatch, isMobileDevice, openModal, setOpenModal, theme, gamesIndex, games }) {
    const formik = useFormik({
        initialValues: {
            name: games.data[gamesIndex].GAMEGROUP_NAME || '',
            description: games.data[gamesIndex].DESCRIPTION || '',
            id: games.data[gamesIndex].GAMEGROUP_ID
        },
