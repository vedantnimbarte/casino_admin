...
import { updateLoyaltyPack } from 'store/thunk/configuration/loyaltyPack.thunk';

function UpdateLoyaltyPack({ loyaltyPack, dispatch, isMobileDevice, openModal, setOpenModal, theme, loyaltyPackIndex }) {
...
export default UpdateLoyaltyPack;
