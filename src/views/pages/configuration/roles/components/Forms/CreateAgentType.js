...
import { createAgentType, getAgentType } from 'store/thunk/configuration/agentType.thunk';

function CreateAgentType({ agentType, dispatch, isMobileDevice, openModal, setOpenModal, theme, roleSchema, pageNo, pageLmit }) {
