...
function BlockConfirmation({ dispatch, openDialog, setOpenDialog, agentId }) {
    return (
        <Dialog
            open={openDialog}
        ...
        >
            ...
            <DialogContent>
                <DialogContentText id="alert-dialog-description">Are you sure you want to block this agent?</DialogContentText>
            </DialogContent>
            <DialogActions>
